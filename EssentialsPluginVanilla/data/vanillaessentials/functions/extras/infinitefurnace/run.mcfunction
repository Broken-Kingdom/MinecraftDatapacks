...
execute as @e[type=armor_stand] at @s if entity @e[type=item,nbt={Item: {id: "minecraft:furnace", Count: 1b, tag: {Furnace: 1b}}},distance=..1] unless entity @e[type=armor_stand,name=Furnace,distance=..1] run data merge entity @s {Small: 1b, NoGravity: 1b, Invisible: 1b, CustomName:"\"Furnace\""}
...
execute as @e[type=armor_stand] at @s if entity @e[type=item,nbt={Item: {id: "minecraft:blast_furnace", Count: 1b, tag: {Furnace: 1b}}},distance=..1] unless entity @e[type=armor_stand,name=BlastFurnace,distance=..1] run data merge entity @s {Small: 1b, NoGravity: 1b, Invisible: 1b, CustomName:"\"BlastFurnace\""}
...
execute as @e[type=armor_stand] at @s if entity @e[type=item,nbt={Item: {id: "minecraft:smoker", Count: 1b, tag: {Furnace: 1b}}},distance=..1] unless entity @e[type=armor_stand,name=Smoker,distance=..1] run data merge entity @s {Small: 1b, NoGravity: 1b, Invisible: 1b, CustomName:"\"Smoker\""}
