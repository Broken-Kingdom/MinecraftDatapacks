...
function vanillaessentials:extras/crafting/blocks/barrier
function vanillaessentials:extras/infinitefurnace/run
function vanillaessentials:extras/explosion/run